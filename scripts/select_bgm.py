...
Eight-bar statements form A / A+ / bridge / A-final. A syncopated rising hook
...
HOOK = (
    ((0, "A4", .28, .94), (.5, "C5", .62, .72),
     (1.5, "D5", .62, 1), (2.5, "E5", .28, .68), (3, "D5", .62, .90)),
    ((.5, "B4", .28, .74), (1, "A4", .28, .70),
     (1.5, "G4", .62, .90), (2.5, "A4", .28, .68), (3, "B4", .62, .86)),
    ((0, "G4", .28, .94), (.5, "B4", .62, .72),
     (1.5, "D5", .62, 1), (2.5, "E5", .28, .68), (3, "D5", .62, .90)),
    ((.5, "C#5", .62, .86), (1.5, "B4", .62, .74),
     (2.5, "A4", .28, .82), (3, "E5", .62, .88)),
    ((0, "A4", .28, .94), (.5, "C5", .62, .72),
     (1.5, "D5", .62, 1), (2.5, "F5", .28, .68), (3, "E5", .62, .90)),
    ((.5, "D5", .28, .74), (1, "B4", .28, .70),
     (1.5, "A4", .62, .90), (2.5, "G4", .28, .68), (3, "E4", .62, .86)),
    ((0, "G4", .28, .94), (.5, "Bb4", .62, .72),
     (1.5, "D5", .62, 1), (2.5, "F5", .28, .68), (3, "E5", .62, .90)),
    ((.5, "C#5", .28, .74), (1, "B4", .28, .70),
     (1.5, "A4", .62, .90), (2.5, "G4", .62, .68), (3.5, "C#5", .28, .86)),
)
BRIDGE = (
