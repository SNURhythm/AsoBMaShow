...
beatorajaIntegerValueProperties() noexcept {
  ...
  static constexpr auto aliases = std::to_array<BeatorajaNamedIntegerValueProperty>({
      ...
      {"folder_noplay", 320}, {"folder_failed", 321},
      {"folder_assist", 322}, {"folder_lightassist", 323},
      {"folder_easy", 324}, {"folder_normal", 325},
      {"folder_hard", 326}, {"folder_exhard", 327},
      {"folder_fullcombo", 328}, {"folder_prefect", 329},
      {"folder_max", 330},
