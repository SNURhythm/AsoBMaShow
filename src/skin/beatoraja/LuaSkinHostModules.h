...
struct LuaSkinHostModulesOptions {
  ...
  // `require` searches this host-side path synchronously, outside Lua's
  // instruction hook. Keep the number of path entries finite whenever the
  // runtime resource budget is enabled.
