...
struct IrRankingScoreDetailPresentation {
  ...
  std::string rateText;
  std::string lampText;
  std::string totalPGreatText;
  std::string totalGreatText;
  std::string totalGoodText;
  std::string totalBadText;
  std::string totalPoorText;
  std::string earlyPGreatText;
  std::string latePGreatText;
  std::string earlyGreatText;
  std::string lateGreatText;
  std::string earlyGoodText;
  std::string lateGoodText;
  std::string earlyBadText;
  std::string lateBadText;
  std::string earlyPoorText;
  std::string latePoorText;
  std::string badPointsText;
  std::string maxComboText;
  std::string achievementTimeText;
