...
- [ ] **Step 2: Define test doubles and make the RED store tests reference these concrete lifecycle/validator contracts**:
  ...
  public:
    ...
    // consumes cleanup ownership. A zero-ticket result means closed/full and
    // transfers cleanup back in rejectedCleanup. Each accepted request owns
    // its immutable progress mailbox; discarding it detaches UI safely.
