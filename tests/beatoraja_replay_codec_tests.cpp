...
void testIndependentBeatorajaFixtures() {
  // Generated by ReplayData.shrink() and libGDX Json from Beatoraja commit
  // 5f46fe198e88abbefe9215ca2de397aef8f54bd8. Source paths:
  // src/bms/player/beatoraja/ReplayData.java
...
void testAsoExtensionRoundTripsWithoutBreakingStock() {
  ...
  if (courseEncoded) {
    ...
    expect(stockCourse.is_array() && stockCourse.size() == 2,
           "stock reader sees a normal two-stage ReplayData array");
