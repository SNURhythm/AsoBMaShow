...
opt-in external audit. It pins the Beatoraja commit, SCURO 4.6 archive and tree
...
frozen manifest value. Changing any loaded byte or identity, adding or removing
a loaded file, or selecting another archive requires an explicit manifest and
acceptance review.
...
python3 scripts/audit_beatoraja_skin.py \
  ...
  --archive-path /external/path/ModernChic460.zip \
